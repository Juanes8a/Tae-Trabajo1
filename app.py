...
* Educativo: Puntuación en SAT, Tasa de admisiones(Alta-Media-Baja), interes en intersemestrales, índice en becasPell y préstamos federales.
"""
...
tipo = ("Cualquiera", "Privada","Pública")
...
def top ():
    ...
    if stateOptions !="Todos":
        ...
        return filtrado3.head(10)
    return filtrado2.head(10)
